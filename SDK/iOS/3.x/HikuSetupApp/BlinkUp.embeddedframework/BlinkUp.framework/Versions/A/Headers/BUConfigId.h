 ...
 */
  typedef void (^BUConfigIdCompletionHandler)(BUConfigId *configId, NSError *error);
 ...
 */
- (instancetype)initWithApiKey:(NSString *)apiKey completionHandler:(BUConfigIdCompletionHandler)completionHandler;
 ...
 *  @return ConfigId that may or may not be active
 */
- (instancetype)initWithApiKey:(NSString *)apiKey planId:(NSString *)planId completionHandler:(BUConfigIdCompletionHandler)completionHandler NS_DESIGNATED_INITIALIZER;
