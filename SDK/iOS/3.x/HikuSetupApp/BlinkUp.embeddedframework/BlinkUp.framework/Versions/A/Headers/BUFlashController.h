 ...
 */
typedef void (^FlashResignActiveBlock)(BOOL willRespond, BUDevicePoller *devicePoller, NSError *error);
 ...
 */
- (void)presentFlashWithNetworkConfig:(BUNetworkConfig *)networkConfig
  configId:(BUConfigId *)configId
  animated:(BOOL)animated
  resignActive:(FlashResignActiveBlock)resignActive;
 ...
 */
@property (nonatomic, readonly, strong) BUFlashStringParameters *stringParams;
