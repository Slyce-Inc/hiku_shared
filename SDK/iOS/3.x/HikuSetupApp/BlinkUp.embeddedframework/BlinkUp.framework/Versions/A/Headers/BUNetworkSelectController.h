 ...
 */
- (void)presentInterfaceAnimated:(BOOL)animated completionHandler:(void (^)(BUNetworkConfig *networkConfig, BOOL userDidCancel))completionHandler;
 ...
 */
@property (nonatomic, strong, readonly) BUNetworkSelectStringParameters *stringParams;
