 ...
 */
typedef void (^DevicePollingDidCompleteBlock)(BUDeviceInfo *deviceInfo, BOOL timedOut, NSError *error);
 ...
 */
- (instancetype)initWithConfigId:(BUConfigId *)configId NS_DESIGNATED_INITIALIZER;
 ...
 */
- (void)startPollingWithCompletionHandler:(DevicePollingDidCompleteBlock)completionHandler;
 ...
 */
@property (nonatomic, strong, readonly) BUConfigId *configId;
@end
